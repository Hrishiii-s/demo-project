  ...
  return (
    <>
      <Head>
        ...
        <meta
          name="description"
          content="Learn about our data protection practices in our Privacy Policy. We take your privacy seriously and outline how we handle personal information with the utmost care and security."
        />
      </Head>
            ...
            <div className="container mt-[20px] lg:mt-[40px]">
              <div className="flex flex-col justify-center items-center mb-6">
                {isMobile ? (
                  <>
                    <h1
                      className={`text-[60px] font-thin leading-[50px] text-center text-black`}
                    >
                      <span className="font-bold text-[#ffcf29]">Privacy</span>
                      <span className="">
                        {' '}
                        <br />&<br />{' '}
                      </span>
                      <span className="font-bold text-lb">Cookie</span> Policy
                    </h1>
                  </>
                ) : (
                  <>
                    <h1
                      className={`text-[60px] font-thin leading-10" text-black`}
                    >
                      <span className="font-bold text-[#ffcf29]">Privacy</span>
                      <span className=""> & </span>
                      <span className="font-bold text-lb">Cookie</span> Policy
                ...
                <h2 className="justify-center items-center text-left mt-12 text-lg">
                  At ECESIS, we are committed to protecting and respecting your
                  privacy. This Privacy Policy outlines how we collect, use,
                  disclose, and safeguard your information when you visit our
                  website or engage with our services. Please read this policy
              ...
              <div className="flex-row flex relative">
                  ...
                  <>
                    <div className="w-[20%] mt-12 ">
                      <ul className="gap-list text-lb">
                        ...
                        <Link href="#info-use" style={{ color: '#00235f' }}>
                          {' '}
                          <li>How We Use Your Information</li>
                        </Link>

                        <Link href="#info-share" style={{ color: '#00235f' }}>
                          {' '}
                        ...
                        <Link href="#third-party" style={{ color: '#00235f' }}>
                          {' '}
                          <li>Third-Party Links</li>{' '}
                        </Link>

                        <Link href="#changes" style={{ color: '#00235f' }}>
                          <li>Changes to This Privacy Policy</li>{' '}
                        </Link>

                        <Link href="#contact" style={{ color: '#00235f' }}>
                          {' '}
                          <li>Contact Us</li>
                        </Link>
                      </ul>
                ...
                <section className="w-full">
                  <div className="mt-12 ml-4" id="info-collect">
                    ...
                    <ul className="list-disc ml-5">
                      <li>
                        ...
                        you voluntarily provide when filling out forms or
                        contacting us through our website.
                      </li>
                      <br />
                      <li>
                        Usage Data: Information about how you use our website,
                        including but not limited to your IP address, browser
                      ...
                      <li>
                        ...
                        remember your preferences, and track site usage. You can
                  ...
                  <div className="mt-12 ml-4" id="info-use">
                    ...
                    <ul className="list-disc ml-5">
                      <li>
                        ...
                        to inquiries, fulfilling requests, and providing
                        customer support.
                      </li>
                      <br />
                      <li>
                        To improve our website and services: We analyze usage
                        data to understand how visitors interact with our
                        website and to improve its functionality.
                      </li>
                      <br />

                      <li>
                        For marketing and communications: With your consent, we
                        may send you information about our services, updates,
                        and promotions that we believe may be of interest to
                        you.
                      </li>
                      <br />
                      <li>
                        Compliance with legal obligations: To comply with
                  ...
                  <div className="mt-12 ml-4" id="info-share">
                    ...
                    <ul className="list-disc ml-5">
                      <li>
                        With service providers: We may share your data with
                        third-party service providers who assist us in operating
                        our website, conducting our business, or servicing
                        you.{' '}
                      </li>
                      <br />
                      <li>
                        For legal purposes: If required by law or if we believe
                        it is necessary to protect our rights, property, or
                        safety, we may disclose your information to comply with
                        legal obligations.{' '}
                      </li>
                      <br />
                  ...
                  <div className="mt-12 ml-4" id="data-sec">
                    ...
                    <p>
                      ...
                      However, please be aware that no transmission over the
                  ...
                  <div className="mt-12 ml-4" id="rights">
                    ...
                    <ul className="list-disc ml-5">
                      ...
                      <br />
                      <li>
                        Correction: You have the right to request that we
                      ...
                      <br />
                      <li>
                        Objection to processing: You can object to the
                  ...
                  <div className="mt-12 ml-4" id="third-party">
                    ...
                    <p>
                      ...
                      of such websites. We encourage you to read the privacy
                      policies of any third-party sites you visit. <br />
                    </p>
                  </div>
