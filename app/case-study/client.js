...
function CaseStudy() {
  ...
  return (
    <>
      <Head>
        <title>
          Case Studies | Success Stories in AI, PropTech, and Digital
          Transformation
        </title>
        <meta
          name="description"
          content="Explore our case studies to see how we’ve helped businesses transform with AI, PropTech, and digital solutions. Discover real-world examples of innovation, growth, and success across various industries."
        />
      </Head>
      <Layout
        headerStyle={3}
