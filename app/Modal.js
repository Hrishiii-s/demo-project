    ...
    >
      ...
      >
        <img
          src={imageUrl}
          alt="Profile"
          className={`md:w-1/3 md:h-auto object-cover rounded-lg ${isMobile ? 'w-full mt-3' : 'h-full'}`}
        />

        <div
          className="flex flex-col w-full mt-4 md:mt-0 md:ml-3 overflow-y-auto"
          style={{ maxHeight: '70vh' }}
        >
          <h1 className="text-xl text-center sm:text-left sm:text-2xl font-bold">
            {title}
          </h1>
          <p
          ...
          <a
            href={linkedInUrl}
            className="text-blue-500 mt-2 md:ml-3"
            target="_blank"
