...
export default function Contact() {
  ...
  const sendEmail = async () => {
    ...
    try {
      ...
      const response = await axios.post(
        `/api/recaptcha?token=${recaptchaToken}`
      );
  ...
  return (
    <>
      <Head>
        <title>Contact Us | Get in Touch for Innovative Tech Solutions</title>
        <meta
          name="description"
          content="Reach out to us for expert advice on AI-driven technology, PropTech, and digital transformation services. Our team is ready to assist you with tailored solutions for your business needs."
        />
      </Head>
      <Layout
        headerStyle={3}
        footerStyle={3}
        breadcrumbTitle="Let’s get in touch"
        Nothome={Nothome}
      >
        <div>
                ...
                <div className="col-lg-7">
                  <div className="contact__form-wrap">
                    ...
                    >
                      ...
                      <label
                        htmlFor="enquiry"
                        className="block mb-2 ml-2 text-base font-medium text-gray-900 "
                      >
                        Type of Enquiry
                      </label>
                      <select
                        ...
                        required
                        id="enquiry"
                        className="bg-white border border-gray-300 text-gray-900 text-sm rounded-lg focus:ring-blue-500 focus:border-blue-500 block w-full p-2.5 dark:bg-gray-700 dark:border-gray-600 placeholder-gray-400  dark:focus:ring-blue-500 dark:focus:border-blue-500"
                      ...
                      <ul className="list-wrap">
                        <li className="mt-6">
                          <div className="mb-[77px]">
                            <img
                              src="/assets/img/icon/india.webp"
                              alt=""
                              className="w-12"
                            />
                          </div>
                          <div className="content">
                            ...
                            <p>
                              2nd Floor, Temple Square - PPD <br /> Ambalamukku
                              Junction,
                              <br /> Kowdiar P.0 Trivandrum. 695003 <br />
                              Kerala, India
                            </p>
                        ...
                        <li className="mt-6">
                          ...
                          <div className="content">
                            ...
                            <p>
                              4830 West Kennedy Boulevard, Tampa
                              <br />
                              Florida - 33609
                              <br />{' '}
                            </p>
                        ...
                        <li>
                          ...
                          <div className="content">
                            ...
                            <Link href="mailto:info@ecesistech.com">
                              info@ecesistech.com
                            </Link>
                          </div>
                        </li>
