                  ...
                  <div className="col-12">
                      ...
                      <div className="row">
                        <div className="col-70">
                          <div className="project__details-thumb">
                            <img
                              src="/assets/img/project/project_details01.webp"
                              alt=""
                            />
                          </div>
                        </div>
                    ...
                    <div className="project__details-content">
                      <h3 className="text-3xl">
                        Transforming Industries with Accurate and reliable
                        Valuation Solutions using AI. <br />
                        <span className="text-2xl font-normal">
                          Revolutionize Your Operations with Unmatched Precision
                          and Flexibility.
                        </span>
                      </h3>
                      <div className="project__details-inner">
                        <div className="row align-items-center">
                          ...
                          <p className="">
                            Smart Value stands at the cutting edge of Valuation
                            technology, offering unparalleled versatility and
                            precision across industries. Central to Smart Value,
                            innovation is its foundation on state-of-the-art
                            machine learning algorithms, including Python - need
                            to add technologies if any. This powerful tool is
                            adept at analyzing available data with unmatched
                            accuracy, thanks to extensive training on a diverse
                            data set. The essence of Smart Value capability lies
                            in its adaptability; with specific datasets for
                            training, it can be tailored to meet any use case.
                          </p>
                          {/* <div>
              ...
              <div className="row">
                <div className="col-lg-6">
                  <div className="call-back-content">
                    ...
                    <div className="shape">
                      <img
                        src="/assets/img/images/call_back_shape.webp"
                        alt=""
                        data-aos="fade-right"
                        data-aos-delay={400}
                      />
