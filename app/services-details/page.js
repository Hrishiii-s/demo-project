                ...
                <div className="row">
                  <div className="col-70 order-0 order-lg-2">
                    <div className="services__details-thumb">
                      <img
                        src="/assets/img/services/services_details01.webp"
                        alt=""
                      />
                    </div>
                    <div className="services__details-content">
                      <h2 className="title">
                        Modern Business Investment Planning
                      </h2>
                      <p>
                        ...
                        <div className="row gutter-24 align-items-center">
                          <div className="col-44">
                            <div className="services__details-inner-img">
                              <img
                                src="/assets/img/services/services_details_inner01.webp"
                                alt=""
                              />
                              <VideoPopup />
                            </div>
                    ...
                    <aside className="services__sidebar">
                      ...
                      <div className="sidebar__widget">
                        ...
                        <div className="sidebar__brochure">
                          ...
                          <Link
                            href="/assets/img/services/services_details01.webp"
                            target="_blank"
                            download
                          >
                        ...
                        <div className="sidebar__post-list">
                          <div className="sidebar__post-item">
                            <div className="sidebar__post-thumb">
                              <Link href="/blog-details">
                                <img
                                  src="/assets/img/blog/sb_post01.webp"
                                  alt=""
                                />
                              </Link>
                            </div>
                          ...
                          <div className="sidebar__post-item">
                            <div className="sidebar__post-thumb">
                              <Link href="/blog-details">
                                <img
                                  src="/assets/img/blog/sb_post02.webp"
                                  alt=""
                                />
                              </Link>
                            </div>
                          ...
                          <div className="sidebar__post-item">
                            <div className="sidebar__post-thumb">
                              <Link href="/blog-details">
                                <img
                                  src="/assets/img/blog/sb_post03.webp"
                                  alt=""
                                />
                              </Link>
                            </div>
                          ...
                          <div className="sidebar__post-item">
                            <div className="sidebar__post-thumb">
                              <Link href="/blog-details">
                                <img
                                  src="/assets/img/blog/sb_post04.webp"
                                  alt=""
                                />
                              </Link>
                            </div>
