...
export default function ServicesDetails() {
  ...
  return (
    <>
      <Head>
        <title>
          Real Estate Valuation Services | Accurate and Efficient Property
          Valuations
        </title>
        <meta
          name="description"
          content="Our real estate valuation services offer accurate, technology-powered property assessments tailored to your business needs. Streamline your valuation process for faster, more reliable results."
        />
      </Head>
      <Layout
        headerStyle={3}
        footerStyle={3}
        breadcrumbTitle="Real Estate Valuations"
        Nothome={Nothome}
      >
        <div>
              ...
              <div className="services__details-wrap">
                <div className="row">
                  <div className="col-100 order-0 order-lg-2">
                    ...
                    <div
                      className="services__details-content"
                      id="data-process"
                    >
                      <h1
                        className={` ${isMobile ? 'text-center text-3xl' : 'text-5xl mb-3'} `}
                      >
                        Transforming Real Estate Valuations
                        <br /> with
                      ...
                      <p>
                        We specialize in Broker Price Opinion services that
                        empower real estate professionals across the U.S.
                        Started in 2010, ECESIS has established itself as a
                        leader in the real estate valuation industry, known for
                        our precision, reliability, and innovative solutions.
                        For over a decade, we have provided US-based realtors,
                        brokers, and real estate companies with precise
                        valuations and Comparative Market Analysis (CMA). Our
                        commitment to high-quality, value-driven deliverables
                        ensures that you remain proactive, decisive, and
                        adaptable as your business evolves and expands.
                      </p>
                      <h3 className="text-center text-3xl mt-5 ">
                        Enhanced BPO Management with ECESIS
                      </h3>
                      <div
                        className={`w-full border-2 bg-slate-100 rounded-3xl mt-12 ${isMobile ? 'px-5' : 'px-10'}  pt-7 pb-9 `}
                      >
                                ...
                                <div className="content">
                                  <div className="icon">
                                    ...
                                    <h4 className="title text-left">
                                      ...
                                      BPO Portal Registration and Management
                                    </h4>
                                  </div>
                                  <p className={` ${isMobile ? '' : 'ml-8'}`}>
                                    Our team facilitates seamless registration
                                    with over 100 leading BPO portals and asset
                                    management companies. This service ensures
                            ...
                            <div className="">
                              <div className="services__details-list-box">
                                ...
                                <div className="content mt-3">
                                  ...
                                  <p className={` ${isMobile ? '' : 'ml-8'} `}>
                                    Our proprietary software, BPO Acceptor, is
                                    designed to immediately capture available
                                    orders by swiftly solving captchas and
                                    performing regional compliance checks. This
                                    ultra-fast process ensures you secure all
                                    available opportunities without delay.
                                  </p>
                                </div>
                              </div>
                            </div>
                            <div className="">
                              <div className="services__details-list-box">
                                ...
                                <div className="content mt-3">
                                  ...
                                  <p className={` ${isMobile ? '' : 'ml-8'}`}>
                                    Our skilled team handles all aspects of data
                                    processing, from initial order capture to
                                    comprehensive market analysis and
                                    comparative research. We ensure each report
                                    is detailed, accurate, and aligned with
                                    current market data.
                                  </p>
                                </div>
                              </div>
                        ...
                        <div className="row gutter-24 align-items-center">
                          <div className="flex flex-col items-center justify-center w-full">
                            <div className="services__details-inner-img flex items-center justify-center w-[45%]">
                              <img
                                src="/assets/img/images/thumbnail2.webp"
                            ...
                            <div>
                              <h4
                                className="font-semibold mb-6 uppercase text-center mt-3"
                                style={{ fontSize: '25px' }}
                              >
                                WATCH HOW TO GET{' '}
                                <span
                          ...
                          <div className="">
                            <div className="services__details-inner-content mt-5">
                              ...
                              <h5 className="title text-center mt-9">
                                What differentiates us
                              </h5>
                              <p className="text-center mb-10">
                                We're a one-stop solution for all your BPO
                                needs. We support you end-to-end, from
                                registering portals to submitting reports.
                              </p>
                              <div
                                className={`grid ${isMobile ? 'grid-cols-1' : 'grid-cols-3'} gap-x-4`}
                              >
                                <div className="ebt">
                                  <div
                                    className="title px-3 py-5 border-2 text-center justify-center rounded-2xl"
                                  ...
                                  >
                                    ...
                                    <h4 className="mt-3">
                                      An established & registered service
                                      provider
                                    </h4>

                                    <p className="mt-3 text-gray-500  font-medium">
                                      14+ successful years in the US real estate
                                      industry.
                                    </p>
                                  </div>
                                </div>
                                <div className="ebt">
                                  <div
                                    className="title px-2  border-2 text-center justify-center rounded-2xl "
                                    style={{
                                      width: '390px',
                                      height: '275px',
                                      paddingTop: '26px',
                                  ...
                                  >
                                    <span className="justify-center flex">
                                      <img
                                        src="/assets/img/icon/verified-icon.webp"
                                        className="w-20 h-20"
                                      />
                                    </span>
                                    <h4 className="mt-3">
                                      High acceptance rate and best quality
                                      assurance & control
                                    </h4>

                                    <p className="mt-3 text-gray-500  font-medium">
                                      Track record of 90%+ acceptance rate for
                                      all BPO portals and 92% quality score in
                                      BPO reports.
                                    </p>
                                  </div>
                                </div>
                                <div className="ebt">
                                  <div
                                    className="title px-2 py-4 border-2 text-center justify-center rounded-2xl "
                                    style={{ width: '390px', height: '275px' }}
                                  >
                                    <span className="justify-center flex">
                                      <img
                                        src="/assets/img/icon/handshake-icon2.webp"
                                        className="w-20 h-20"
                                      />
                                    </span>
                                    <h4 className="mt-3">
                                    ...
                                    <p className="mt-3 text-gray-500  font-medium">
                                      We invest both in technology and people to
                                ...
                                <div className="ebt">
                                  ...
                                  >
                                    <span className="justify-center flex">
                                      <img
                                        src="/assets/img/icon/time-icon.webp"
                                        className="w-20 h-20"
                                      />
                                    </span>
                                    <h4 className="mt-3">
                                    ...
                                    <p className="mt-3 text-gray-500  font-medium">
                                      We deliver over 15,000 monthly reports,
                                      with an average TAT of 24 hours.
                                    </p>
                                  </div>
                                </div>
                                <div className="ebt">
                                  ...
                                  >
                                    <span className="justify-center flex">
                                      <img
                                        src="/assets/img/icon/around-the-clock-icon.webp"
                                        className="w-20 h-20"
                                      />
                                    </span>
                                    <h4 className="mt-3">
                                    ...
                                    >
                                      365 x 24 x 7 service with well-defined
                                      SLAs & escalation matrix.
                                    </p>
                                  </div>
                                </div>
                                <div className="ebt">
                                  ...
                                  >
                                    <span className="justify-center flex">
                                      <img
                                        src="/assets/img/icon/isp-icon.webp"
                                        className="w-20 h-20"
                                      />
                                    </span>
                                    <h4 className="mt-3">
                                    ...
                                    <p className="mt-3 text-gray-500  font-medium">
                                      Your web traffic is routed only through
                                      dedicated US IPs within the US border.
                                    </p>
                                  </div>
                                </div>
                              </div>
                              <div className="flex justify-center">
                                <div className="ebt">
                                  <div
                                    className="title px-2 py-4 border-2 text-center justify-center rounded-2xlitems-center "
                                    style={{ width: '390px', height: '275px' }}
                                  >
                                    <span className="justify-center flex">
                                      <img
                                        src="/assets/img/icon/security-icon.webp"
                                        className="w-20 h-20"
                                      />
                                    </span>
                                    <h4 className="mt-3">
                                    ...
                                    <p
                                      ...
                                      style={{ marginTop: '46px' }}
                                    >
                                      Set processes & secure protocols to
          ...
          <section
            ...
            data-background="/assets/img/bg/pricing_bg.webp"
          >
            <div className="container">
              <div className="row justify-content-center">
                <div className="col-xl-5">
                  <div className="section-title text-center mb-30">
                    ...
                    <h2 className="title">
                      Detailed Service Packages and Pricing
                    </h2>
                    <p>
                      ECESIS offers flexible service packages designed to cater
                      to different business scales and needs, ensuring that
                      every client receives the personalized support necessary
            ...
            <div className="pricing__shape-wrap">
              <img
                src="/assets/img/images/pricing_shape01.webp"
                alt=""
                data-aos="fade-right"
                data-aos-delay={400}
              />
              <img
                src="/assets/img/images/pricing_shape02.webp"
                alt=""
                data-aos="fade-left"
                data-aos-delay={400}
              />
