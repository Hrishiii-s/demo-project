    ...
    <Layout headerStyle={3} footerStyle={3} Nothome={Nothome}>
      <main className="bg-gray-50">
        ...
        <section
          ...
          style={{
            backgroundImage: "url('/assets/img/banner/career_banner.jpg')",
          }}
        >
          ...
          <div className="absolute inset-0 bg-black bg-opacity-50 flex items-center justify-center text-center text-white">
            <div>
              ...
              <p className="text-lg text-white">
                Shape the future with us. Explore exciting career opportunities
                and grow with our innovative team.
              </p>
            </div>
          </div>
        </section>
        ...
        <section className="py-16 px-8">
          ...
          <div className="grid grid-cols-1 md:grid-cols-3 gap-8">
            <div className="text-center">
              ...
              <p>
                Work with talented individuals in a supportive and inclusive
                environment.
              </p>
            </div>
            <div className="text-center">
              <img
                src="/assets/img/icon/office.jpg"
                alt="Office"
                className="w-full h-64 object-cover rounded-lg mb-4"
              />
              <h3 className="text-xl font-semibold mb-2">
              ...
              <p>
                Be part of projects that redefine innovation and technology.
              </p>
            </div>
            <div className="text-center">
              <img
                src="/assets/img/icon/growth.webp"
                alt="Growth"
                className="w-full h-64 object-cover rounded-lg mb-4"
              />
        ...
        <section className="py-16 px-8 bg-white">
          ...
          <div className="grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-3 gap-8">
            {jobs.map((job, index) => (
              <div
                key={index}
                className="relative p-6 border rounded-lg shadow-md hover:shadow-lg transition-shadow bg-white"
              >
                {/* Top Streak */}
        ...
        <section className="py-16 bg-blue-600 text-white text-center">
          ...
          <p className="mb-6 text-white">
            We’re excited to work with individuals who are passionate, driven,
            and ready to make a difference. Apply today!
          </p>
