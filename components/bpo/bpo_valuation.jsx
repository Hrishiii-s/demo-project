...
export const BpoValuation = () => {
  const bullets = [
    {
      bold: "Rising expenses",
      text: "Overtime, temporary help, and per-unit costs that keep increasing",
    },
    {
      bold: "Cost pressure during peak volumes",
      text: "Forcing teams to scale quickly at higher expense",
    },
    {
    ...
    },
    {
      ...
      text: "Borrower expectations and closing deadlines don't wait",
    },
    {
      bold: "Quality & compliance risk",
      text: "Documentation gaps that create compliance and audit risk",
    },
    {
  ...
  return (
    <section className="relative min-h-screen bg-gradient-to-br from-indigo-100 via-blue-50 to-purple-100 overflow-hidden">
      {/* Background accents */}
      ...
      <div className="max-w-7xl mx-auto px-6 min-h-full flex flex-col justify-center py-12 sm:py-16">
        {/* Heading */}
        <motion.div
        ...
        >
          <div
            className="
              ...
              rounded-2xl shadow-xl shadow-blue-500/15
              border border-blue-200 p-6 relative
              lg:max-h-[45vh]
            "
          >
