      ...
      <Swiper {...swiperOptions}>
        <SwiperSlide className="swiper-slide slider__single">
          <div
            ...
            data-background="/assets/img/slider/slider_bg01.webp"
          />
              ...
              <div className="col-lg-6">
                <div className="slider__content">
                  ...
                  <p>
                    ...
                    and get business insights Agilos helps you to convert.
                  </p>
        ...
        <SwiperSlide className="swiper-slide slider__single">
          <div
            className="slider__bg"
            data-background="/assets/img/slider/slider_bg02.webp"
          />
          <div className="container">
            <div className="row">
              <div className="col-lg-6">
