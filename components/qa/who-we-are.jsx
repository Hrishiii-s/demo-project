    ...
    <section className="min-h-screen py-12 lg:py-16 px-4 sm:px-6 lg:px-8 bg-gradient-to-br from-pink-50 via-rose-50 to-purple-50 flex items-center">
      <div className="max-w-7xl mx-auto w-full">
        ...
        <div className="text-center mb-10">
          ...
          <p className="text-sm sm:text-base lg:text-lg text-slate-600 max-w-2xl mx-auto px-4 text-balance text-center">
              ...
              {expertise.map((item, index) => (
                ...
                >
                  <div className="flex flex-col items-center h-full">
                    ...
                    <h4
                      className={`
                        text-xs sm:text-sm font-semibold text-center leading-snug
                        ${
                          activeExpertiseIndex === index
                            ? "text-white"
