...
const expertise = [
  ...
  },
  {
    icon: FileX,
    title:
      "Lender-specific quality and compliance guidelines (Fannie Mae, Freddie Mac, FHA, VA)",
  },
  {
    icon: Clock,
...
const benefits = [
  ...
  {
    icon: CheckCircle2,
    title: "Minimal learning curve and limited hand-holding after ramp-up",
  },
];
    ...
    <section className="min-h-screen py-12 lg:py-16 px-4 sm:px-6 lg:px-8 bg-gradient-to-br from-pink-50 via-rose-50 to-purple-50 flex items-center">
      <div className="max-w-7xl mx-auto w-full">
        ...
        <div className="text-center mb-10">
          ...
          <p className="text-sm sm:text-base lg:text-lg text-slate-600 max-w-2xl mx-auto px-4 text-balance">
        ...
        <div className="mb-12 max-w-6xl mx-auto">
          <h3 className="text-lg sm:text-xl lg:text-2xl font-bold text-slate-900 mb-6 text-center">
          ...
          <div className="grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-4 gap-4 auto-rows-fr">
            {expertise.map((item, index) => (
              <div
                ...
                className={`
                  bg-white/90 backdrop-blur-sm border rounded-xl p-5
                  transition-all duration-300 group flex flex-col min-h-full
                  hover:-translate-y-1
                  ${
        ...
        <div className="mt-12 text-center">
          <p className="text-xl font-bold bg-gradient-to-r from-pink-600 via-rose-600 to-purple-600 bg-clip-text text-transparent py-4 px-8 rounded-2xl inline-block">
            We deliver GCC-grade quality (Global Capability Center) at offshore
            pricing.
          </p>
        </div>
      </div>
