...
function Breadcrumb({ breadcrumbTitle, bread, loaded }) {
  ...
  if (isSpecialTitle) {
    specialTitleIndex = specialTitle.findIndex(
        ...
        <>
          <section className={`breadcrumb__area breadcrumb__bg_real_estate`}>
            <div
              ...
              style={{
                height: imageLoaded ? '' : isMobile ? '250px' : '600px',
                backgroundColor: '#fff',
              }}
            >
              <img
                src={
                  matchingBanner
                    ? isMobile && !isTab
                      ? matchingBanner.backgroundMobile
                      : matchingBanner.backgroundImageUrl
                    : null
                }
                alt=""
                className={`${matchingBanner ? matchingBanner.img_style : ''} ${isMobile ? (isSpecialTitle ? 'h-[25vh] object-cover' : 'h-full object-cover') : 'object-fill '}  w-full -z-1 top-0`}
                style={{
                  maxHeight: isWide ? '' : '400px',
                      ...
                      {isSpecialTitle ? (
                        specialTitleIndex === 0 ? (
                          <h2
                            data-aos="fade-up"
                            data-aos-delay={100}
                            className={`title absolute  ${matchingBanner ? matchingBanner.style : '/assets/img/bg/breadcrumb_bg.webp'} ml-3 text-left`}
                            style={{
                              fontSize: isMobile
                                ? '15px'
                                : `${calculatedWidth}px`,
                          ...
                          >
                            ...
                            <br />
                            How a Single Website Drove
                            <br /> <span className="text-ly">3X</span> Revenue
                            Growth
                          </h2>
                        ) : specialTitleIndex === 1 ? (
                          <>
                            <div
                              className="w-fit h-fit bg-blue-500 absolute justify-center items-center"
                              style={{
                                left: isMobile ? '8%' : '10%',
                                top: isMobile ? '26.5%' : '25%',
                              }}
                            >
                              <h2
                                data-aos="fade-up"
                                data-aos-delay={100}
                                className={`title px-4 pt-4 pb-3 text-center ${matchingBanner ? matchingBanner.style : ''} ml-3 text-left`}
                                style={{
                                  fontSize: isMobile
                                    ? '15px'
                                    : `${calculatedWidth}px`,
                              ...
                              >
                                <span className="text-black">
                                  Enhancing ECG Data Accuracy in <br /> Cardiac
                                  Monitoring through
                                  <br />
                        ...
                        <h2
                          data-aos="fade-up"
                          data-aos-delay={100}
                          className={`title absolute ${matchingBanner ? matchingBanner.style : ''} ml-3 text-left`}
                          style={{
                            fontSize: `${calculatedWidth}px`,
                            left: '10%',
                            top: '40%',
                            display: imageLoaded ? 'block' : 'none',
                          }}
