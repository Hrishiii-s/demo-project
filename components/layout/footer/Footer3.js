      ...
      <footer>
        <div className="footer__area-three">
          <div className="footer__top-three">
            <div
              className={`${isMobile ? 'w-full' : 'container'} mx-auto px-4`}
            >
              <div
                className={`flex ${isMobile ? 'flex-col-reverse' : 'flex-row justify-between items-start'}`}
              >
                <div
                  className={`${isMobile ? 'mt-5' : 'mt-2'} footer-widget text-lb flex-1`}
                >
                  <img
                    src="/assets/img/logo/Logo.webp"
                    className={`${isMobile ? 'hidden' : ''} h-14 mb-5`}
                    alt="logo"
                  />
                  <div className="footer__social-three">
                    ...
                    <ul className="list-wrap">
                      <li>
                        <Link href="https://www.facebook.com/ecesisservices/">
                          <i className="fab fa-facebook-f" />
                        </Link>
                      </li>
                      <li>
                        <Link href="https://x.com/ecesisservices?s=21">
                          <i className="fab fa-twitter" />
                        </Link>
                      </li>
                      <li>
                        <Link href="https://www.instagram.com/ecesistech/profilecard/?igsh=MTVvcnFramdhenJzNA==">
                          <i className="fab fa-instagram" />
                        </Link>
                      </li>
                      <li>
                        <Link href="https://in.linkedin.com/company/ecesis">
                  ...
                  <div
                    className="footer-link-list w-fit flex"
                ...
                <div className="max-w-full">
                  ...
                  >
                    <h3
                      className={`${isMobile ? 'text-[31px] text-left mr-1' : 'text-4xl text-left'} ${showTypewriter ? 'typewriter' : ''} mb-2`}
                    >
                  ...
                  <div className="footer-link-list mt-6">
                    <ul
                      className={`list-wrap ${isMobile ? 'flex justify-evenly' : 'flex ml-auto'} justify-end`}
                    >
                      {/* <li className='mr-5'><Link href="#"><p className='normal-text font-bold'>Careers</p></Link></li> */}
                      <li className="mr-5">
                        <Link href="/about">
                          <p className="normal-text font-bold">About Us</p>
                        </Link>
                      </li>
                      <li className="">
                        <Link href="/contact">
                          <p className="normal-text font-bold">Contact Us</p>
                        </Link>
                      </li>
                    </ul>
                  </div>
            ...
            <div className="container">
              <div className="">
                <div className="copyright-text">
                  <p>
                    Copyright ©<Link href="/">ECESIS 2024</Link> | All Right
                    Reserved
                  </p>
                </div>
              </div>
