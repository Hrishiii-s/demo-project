...
export default function VideoPopup({ style, url }) {
    ...
    return (
        <>
            {!style && <a onClick={() => setOpen(true)} className="play-btn w-[45px] h-[45px] mt-[13px] sm:w-[60px] sm:h-[60px] md:w-[55px] md:h-[55px] lg:w-[70px] lg:h-[70px] md:mt-[15px] popup-video  lg:mt-[15px] xl:mt-[10px] sm:max-md:mt-[30px] text-xs" style={{ marginLeft: '-2px'}}><i className="fas fa-play" /></a>}
