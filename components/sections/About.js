              ...
              <div className="col-lg-6 col-md-9 order-0 order-lg-2">
                <div className="about__img-wrap-seven">
                  ...
                  <div className="about__award-box about__award-box-two2">
                    <img
                      src="/assets/img/images/about_list_img04.webp"
                      alt=""
                    />
                  </div>
                  <div className="shape">
                    <img
                      src="/assets/img/images/h5_about_shape.webp"
                      alt=""
                ...
                <div className="about__content-seven">
                  <div className="section-title mb-25">
                    ...
                    <h2 className="title wow">
                      Business Growth Creativity Meet Our{' '}
                      <span>Agency's Experts</span>
                    </h2>
                  </div>
                  <p>
                    We successfully cope with tasks of varying complexity
                    provide area longerty guarantees and regularly master.We
                    successfully cope varying complexity provide area longerty
                    guarantees.
                  </p>
