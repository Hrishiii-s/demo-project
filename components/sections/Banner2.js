  ...
  return (
    <>
      <Head>
        <Link
          rel="preload"
          href="/assets/img/banner/h3_banner_shape01.webp"
          as="image"
        />
      </Head>
      <section
        className={`banner__area-two  banner__bg-two object-cover ${isMobile ? 'object-right h-screen' : 'h-screen'}`}
        style={{
          ...
          <div className={`row`} style={space}>
            <div className={`col-lg-8 ${isMobile ? 'mt-5' : ''}`}>
              <div className="banner__content-two mb-24 z-0">
                ...
                <h2
                  className={`text-black col-lg-10`}
                  data-aos="fade-up"
                  data-aos-delay={200}
                  style={tstyle}
                >
                  ...
                  and Sustainable <span className="text-blue-400">Growth</span>
                </h2>
                <div onClick={executeScroll}>
                  <Link
                    href="#"
                    className="btn border-btn mt-3 bg-[#00235f]"
                    data-aos="fade-up"
                    data-aos-delay={200}
                  >
                    Get Started
