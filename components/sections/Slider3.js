...
export default function Slider3() {
  ...
  const handleResize = () => {
    ...
    const formQuote = document.querySelector(
  ...
  return (
    <>
      <section className="slider__area slider__area-home8">
        <Swiper
          {...swiperOptions}
          className="swiper-container slider_baner__active slider_baner_home8"
        >
          <div className="swiper-wrapper">
            <SwiperSlide className="swiper-slide slider__single">
              <div
                className="slider__bg"
                data-background="assets/img/home8/banner.webp"
              />
              ...
              <form action="#">
                ...
                <div className="form-grp select-grp">
                  <select name="orderby" className="orderby">
                    <option value="Select Insurance Service">
                ...
                <div className="range-slider-wrap">
                  <div className="range-top">
                    ...
                    <span>
                      $<strong id="rangeValue">{value}</strong>
                    </span>
                  </div>
                  <input
                    className="range"
