          ...
          <Swiper {...swiperOptions} className="swiper-wrapper">
            <SwiperSlide className="swiper-slide slider__single">
              <div
                ...
                data-background="/assets/img/home6/banner.webp"
              />
                  ...
                  <div className="col-lg-7">
                    <div className="banner__content-three">
                      <div className="text-25-years">
                        ...
                        <h4 className="text-experience">
                          Years Experiences
                          <br /> in this field
                        </h4>
                      </div>
                      <span className="sub-title aos-init aos-animate">
                      ...
                      <p>
                        Apexa helps you to convert your data into a strategic
                        asset and get business insights Apexa helps you to
                        convert your data into Asset and get Top-Notch Business
                        Insights.
                      </p>
            ...
            <SwiperSlide className="swiper-slide slider__single">
              <div
                className="slider__bg"
                data-background="/assets/img/home6/banner2.webp"
              />
              <div className="container">
                <div className="row">
                  <div className="col-lg-7">
                    <div className="banner__content-three">
                      ...
                      <p>
                        Don't worry about distance, language or culture. We are
                        right in your country, with leading experts in the
                        financial industry. We are always there for your
                        business.
                      </p>
                      <Link href="/contact" className="btn">
                        Read more
            ...
            <SwiperSlide className="swiper-slide slider__single">
              <div
                className="slider__bg"
                data-background="/assets/img/home6/banner3.webp"
              />
              <div className="container">
                <div className="row">
                  <div className="col-lg-7">
