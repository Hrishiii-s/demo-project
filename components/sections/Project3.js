  ...
  return (
    <>
      <section
        ...
        data-background="/assets/img/bg/h3_project_bg.webp"
      >
            ...
            <div className="col-xl-7 col-lg-8">
              <div className="section-title text-center mb-50 tg-heading-subheading animation-style3">
                ...
                <h2 className="title tg-element-title">
                  We Provide Solutions To <br /> Big Small Organizations For
                  Work
                </h2>
              </div>
            </div>
                  ...
                  <SwiperSlide>
                    <div className="project__item-three shine-animate-item">
                      <div className="project__content-three">
                        ...
                        <p>
                          when anner unknown printer took type and scramble to
                          make specimen book.
                        </p>
                      ...
                      <div className="project__thumb-three shine-animate">
                        <img
                          src="/assets/img/project/h3_project_img01.webp"
                          alt=""
                        />
                      </div>
                    </div>
        ...
        <div className="project__shape-wrap-three">
          <img
            src="/assets/img/project/h3_project_shape01.webp"
            alt=""
            data-aos="fade-left"
            data-aos-delay={400}
          />
          <img
            src="/assets/img/project/h3_project_shape02.webp"
            alt=""
