...
export default function MainService() {
  ...
  return (
    <>
      <div>
        <section
          className="services__area-six services__bg-six"
          data-background="/assets/img/bg/services_bg1.webp"
        >
            ...
            <div className="row align-items-center">
              <div className="col-lg-6">
                <div className="section-title white-title mb-10">
                  ...
                  <h1
                    className={`text-lblue text-5xl ${isMobile ? 'text-center' : 'text-left'}`}
                  >
                    Our Services
                  </h1>
                </div>
                  ...
                  <ul className={`nav nav-tabs`} id="myTab" role="tablist">
                    <div className="col-lg-12">
                      <div className="section-title white-title ">
                        <span className={`text-lblue text-2xl font-extrabold`}>
                          Digital Solutions
                        </span>
                      </div>
                    </div>
                    ...
                    <div className="col-lg-12 mt-14">
                      <div className="section-title white-title">
                        <span className="text-lblue text-2xl font-extrabold mb-3">
                          Business Consulting
                        </span>
                      </div>
                    </div>
                  ...
                  >
                    ...
                    >
                      <div className="services__item-four  shine-animate-item">
                        <div className="services__thumb-four shine-animate">
                          <img
                            src="/assets/img/services/Proptech.webp"
                            className=""
                            alt=""
                          />
                        </div>
                        <div className="services__content-four">
                          <h2 className="title">
                            <Link href="#">PropTech</Link>
                          </h2>
                          <p>
                            Empowering Real Estate with 14+ years of
                            technological excellence. We are a visionary
                            PropTech company dedicated to revolutionizing the
                            real estate industry through cutting-edge
                          ...
                          <div className="about__list-box">
                            <ul className="list-wrap">
                              ...
                              <li>
                                <i className="fas fa-check" /> Tailored Software
                                for Real Estate
                              </li>
                              <li>
                                <i className="fas fa-check" /> Web
                                Development{' '}
                              </li>
                              <li>
                                <i className="fas fa-check" /> Comprehensive
                                PropTech Solutions{' '}
                              </li>
                            </ul>
                          </div>
                          <Link
                            href="/services-details/proptech"
                            className="btn"
                          >
                            Learn More
                          </Link>
                    ...
                    >
                      <div className="services__item-four  shine-animate-item">
                        <div className="services__thumb-four shine-animate">
                          <img
                            src="/assets/img/services/AI.webp"
                            className=""
                            alt=""
                          />
                        </div>
                        <div className="services__content-four">
                          ...
                          <p>
                            ...
                            propel your business to new heights. Our data-driven
                            approach leverages cutting-edge AI and machine
                            learning to transform your business. Make smarter
                            decisions, streamline processes, and craft
                            personalized customer experiences that drive lasting
                            success
                          </p>
                          <div className="about__list-box">
                            <ul className="list-wrap">
                              <li>
                                <i className="fas fa-check" /> AI Solutions
                                Tailored for You{' '}
                              </li>
                              <li>
                                <i className="fas fa-check" /> Machine Learning
                                Expertise{' '}
                              </li>
                              <li>
                                <i className="fas fa-check" /> Solve complex
                                challenges and drive innovation{' '}
                              </li>
                            </ul>
                          </div>
                          <Link
                            href="/services-details/artificial-intelligence"
                            className="btn"
                          >
                            Learn More
                          </Link>
                    ...
                    >
                      <div className="services__item-four shine-animate-item">
                        <div className="services__thumb-four shine-animate">
                          <img
                            src="/assets/img/services/Automation.webp"
                            alt=""
                          />
                        </div>
                        <div className="services__content-four">
                          <h2 className="title">
                            <Link href="#">Business Process Automation</Link>
                          </h2>
                          <p>
                            Optimize your business operations with automation.
                            Our strategic approach enhances efficiency, reduces
                            costs, and streamlines processes, creating a solid
                            foundation for sustained success.
                            <br />
                            <br />
                            Crafted to fit your unique business requirements,
                            our solutions enhance speed and accuracy while
                            reducing costs and streamlining FTE management,
                            keeping you ahead in the competitive landscape.{' '}
                          </p>
                          <div className="about__list-box">
                            <ul className="list-wrap">
                              <li>
                          ...
                          <Link
                            href="/services-details/business-process-automation"
                            className="btn"
                          >
                            Learn More
                          </Link>
                    ...
                    >
                      <div className="services__item-four shine-animate-item">
                        ...
                        <div className="services__content-four">
                          <h2 className="title">
                            <Link href="#">Enterprise Software Solutions</Link>
                          </h2>
                          <p>
                            Tailored to meet the unique needs of your business,
                            our web application solutions enhance online
                            visibility and operational efficiency, ensuring you
                          ...
                          <Link
                            href="/services-details/software-development"
                            className="btn"
                          >
                            Learn More
                          </Link>
                    ...
                    >
                      <div className="services__item-four shine-animate-item">
                        <div className="services__thumb-four shine-animate">
                          <img
                            src="/assets/img/services/RealEstate.webp"
                            alt=""
                          />
                        </div>
                        <div className="services__content-four">
                          <h2 className="title">
                            <Link href="#">Real Estate Valuation</Link>
                          </h2>
                          <p>
                            For over a decade, we have partnered with realtors,
                            brokers, and real estate companies with precise
                            valuations and Comparative Market Analysis (CMA).
                            Our commitment to high-quality, value-driven
                            deliverables ensures that you remain proactive,
                            decisive, and adaptable as your business evolves and
                            expands.
                          </p>{' '}
                          <div className="about__list-box">
                            <ul className="list-wrap">
                              <li>
                                <i className="fas fa-check" />
                                Trusted partner to 150+ realtors
                              </li>
                              <li>
                                <i className="fas fa-check" />
                    ...
                    >
                      <div className="services__item-four shine-animate-item">
                        <div className="services__thumb-four shine-animate">
                          <img
                            src="/assets/img/services/Accounting.webp"
                            alt=""
                          />
                        </div>
                        <div className="services__content-four">
                          ...
                          <p>
                            We specialize in identifying and unlocking
                            accounting gaps while confidently and efficiently
                            navigating the complexities of tax compliance. Our
                            suite of services is designed to bring harmony,
                            accuracy, and strategic insight to all your
                            financial processes.
                          </p>
                          <div className="about__list-box">
                            <ul className="list-wrap">
                          ...
                          <Link
                            href="/services-details/accounting-finance"
                            className="btn"
                          >
                            Learn More
                          </Link>
                    ...
                    >
                      <div className="services__item-four shine-animate-item">
                        <div className="services__thumb-four shine-animate">
                          <img
                            src="/assets/img/services/ManpowerStaffing.webp"
                            alt=""
                          />
                        </div>
                        <div className="services__content-four">
                          ...
                          <p>
                            We specialize in placing trained precision and
                            assembly line engineers and other skilled manpower
                            for various sectors. Choose us for a staffing
                            strategy that goes beyond conventional solutions,
                            delivering unparalleled results tailored to your
                            organizational goals. We offer sophisticated
                            solutions encompassing <br /> end-to-end
                            recruitment, general staffing, executive hiring, and
                            various other services to meet contractual or
                          ...
                          <Link
                            href="/services-details/engineering-services"
                            className="btn"
                          >
                            Learn More
                          </Link>
                    ...
                    >
                      <div className="services__item-four shine-animate-item">
                        <div className="services__thumb-four shine-animate">
                          <img
                            src="/assets/img/services/DigitalMarketing.webp"
                            alt=""
                          />
                        </div>
                        <div className="services__content-four">
                          ...
                          <p>
                            We help you in positioning and promoting your brand,
                            bringing in new customers at optimum costs and
                            helping you win new & exciting business deals that
                            improve your brand value.
                            <br />
                            <br />
                            We help businesses get better returns on their
                            marketing expenditure, e-commerce sites sell more
                            goods, local businesses dominate their geographic
                            areas and corporate entities have a better brand
                            reputation.{' '}
                          </p>
                          {/* <div className="about__list-box">
                                                        <ul className="list-wrap">
                          ...
                          <Link
                            href="/services-details/digital-marketing"
                            className="btn"
                          >
                            Learn More
                          </Link>
