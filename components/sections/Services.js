...
export default function Services() {
  return (
    <>
      <section className="services__area-seven services__area-home7 services__bg-seven">
        <div className="icon-line">
          <img src="/assets/img/home7/icon-line.svg" />
        </div>
        <div className="icon-snow">
          <img src="/assets/img/home7/icon-snow.svg" />
        </div>
        <div className="icon-star">
          <img src="/assets/img/home7/icon-star.svg" />
        </div>
          ...
          <div className="row justify-content-center">
            <div className="col-lg-7">
              <div className="section-title text-center mb-50">
                ...
                <h2 className="title">
                  Expert Financial and Accounting
                  <br className="d-none d-lg-block" /> Services for Businesses
                </h2>
              </div>
            </div>
          </div>
          <div className="row justify-content-center gutter-24 services__item-style-2">
            <div className="col-xl-3 col-lg-4 col-md-6">
              <div className="services__item-five">
                ...
                <div className="services__content-five">
                  ...
                  <p>
                    Financial planning and analysis services to help you make
                    informed business decisions and maximize profitability.
                  </p>
            ...
            <div className="col-xl-3 col-lg-4 col-md-6">
              <div className="services__item-five">
                ...
                <div className="services__content-five">
                  ...
                  <p>
                    Tax planning and compliance services to ensure you meet all
                    regulatory requirements and minimize tax liabilities.
                  </p>
                  <Link href="/services-details" className="btn">
                    Read More
                  </Link>
            ...
            <div className="col-xl-3 col-lg-4 col-md-6">
              <div className="services__item-five">
                ...
                <div className="services__content-five">
                  ...
                  <p>
                    Accurate and reliable bookkeeping and payroll services to
            ...
            <div className="col-xl-3 col-lg-4 col-md-6">
              <div className="services__item-five">
                ...
                <div className="services__content-five">
                  ...
                  <p>
                    Customized financial reporting and compliance services
