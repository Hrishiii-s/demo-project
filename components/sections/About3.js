          ...
          <div className="row align-items-center justify-content-center">
            <div className="col-lg-6 col-md-8">
              <div className="about__img-wrap-three">
                {isMobile ? (
                  <img
                    src="/assets/img/images/about_3.webp"
                    className="w-full"
                    alt=""
                  />
                ) : (
                ...
                <div className="shape">
                  <img
                    src="/assets/img/images/h3_about_img_shape.webp"
                    alt=""
            ...
            <div className="col-lg-6">
              <div className="about__content-three">
                ...
                <h2 className="text-lb text-lg mt-2">
                  We offer cutting-edge solutions designed to optimize
                  operations, enhance decision-making, and drive growth. With
                  our expertise in advanced technologies and deep industry
                  knowledge, we create solutions that are uniquely suited to
                  your goals.
                </h2>
                ...
                <div className={`about-bottom sm:text-lg about-bottom-two `}>
                  <div className="author-wrap">
                    ...
                    <p className="text-lb">
                      Our mission is to empower clients through strategic
                      partnerships, driving value and growth in their
                  ...
                  <div className="about__phone">
                    ...
                    <p className="text-lb">
                      Our vision is to be the leader in delivering innovative,
                      technology-driven solutions that empower transformative
                      client experiences and create lasting value.{' '}
                    </p>
                    {/* <div className="icon">
                ...
                <div className="about__shape-wrap-three">
                  <img
                    src="/assets/img/images/h3_about_shape01.webp"
                    alt=""
                    className="rotateme"
                  />
                </div>
