              ...
              <div className="col-lg-6">
                <div className="banner-col-1">
                  <div className="section-title mb-20 tg-heading-subheading animation-style3">
                    ...
                    <h2 className="title tg-element-title text-60-bold">
                      <span>Accounting Platform using </span> AI{' '}
                      <span>technology</span>
                    </h2>
                  </div>
                  <p>
                    Empower decision-making with real-time financial reporting,
                    providing instant access to key metrics, profit and loss
                    statements, and other critical data for informed business
                    strategies.
                  </p>
