...
export function FinalCTA() {
  ...
  return (
    <section id="contact" className="py-24 lg:py-32 px-6 lg:px-12 bg-gradient-to-br from-indigo-50 via-purple-50 to-pink-50">
      <div className="max-w-[1400px] mx-auto w-full">
        <div className="text-center mb-16">
          ...
          <p className="text-2xl text-slate-600 max-w-4xl mx-auto mb-6 leading-relaxed">
            Let our experienced teams become your extended quality assurance and verification partner, helping your organization maintain accuracy, efficiency, and compliance across operations.
          </p>
        ...
        <div className="grid lg:grid-cols-[1.2fr_0.8fr] gap-12 max-w-6xl mx-auto">
          ...
          <div className="bg-white rounded-3xl shadow-2xl p-10 lg:p-12">
            ...
            <form onSubmit={handleSubmit} className="space-y-7">
              <div>
                <Label htmlFor="name" className="text-slate-900 mb-3 block font-semibold text-base">
                  Full Name *
                </Label>
                <Input
                  id="name"
              ...
              <div>
                <Label htmlFor="email" className="text-slate-900 mb-3 block font-semibold text-base">
                  Work Email *
                </Label>
                <Input
                  id="email"
              ...
              <div>
                <Label htmlFor="company" className="text-slate-900 mb-3 block font-semibold text-base">
                  Company Name *
                </Label>
                <Input
                  id="company"
              ...
              <div>
                <Label htmlFor="message" className="text-slate-900 mb-3 block font-semibold text-base">
                  How can we help? *
                </Label>
                <Textarea
                  id="message"
          ...
          <div className="flex flex-col justify-center space-y-10 lg:pl-6">
            <div>
              ...
              <p className="text-slate-600 text-lg leading-relaxed">
                Our quality assurance specialists are ready to discuss your operational needs and provide tailored solutions for your organization.
              </p>
            </div>
            ...
            <div className="space-y-6">
              <div className="flex items-start gap-5">
                ...
                <div>
                  <p className="font-bold text-slate-900 text-base mb-1">Phone</p>
              ...
              <div className="flex items-start gap-5">
                ...
                <div>
                  <p className="font-bold text-slate-900 text-base mb-1">Email</p>
              ...
              <div className="flex items-start gap-5">
                ...
                <div>
                  <p className="font-bold text-slate-900 text-base mb-1">Office</p>
                  <p className="text-slate-600 text-base">Multiple Delivery Centers in India</p>
                </div>
              </div>
            </div>
            ...
            <div className="pt-6 border-t-2 border-slate-200">
              <p className="text-base text-slate-600 leading-relaxed">
                <span className="font-bold text-slate-900 block mb-2">Response Time:</span>
